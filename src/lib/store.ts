// lib/store.ts
// MODELO CORRECTO: B/.4,000 fijos al mes incluyen 14,000 minutos.
// Sin costo variable. Minutos no usados se acumulan.
...
export interface CarteraData {
  ...
  asesores: number
  clientes: number
  honorarioPct: number       // % de comisión sobre el recaudo (ej: 0.10 = 10%)
  masivos: number
...
// COSTO FIJO MENSUAL DEL AV (incluye 14,000 min)
